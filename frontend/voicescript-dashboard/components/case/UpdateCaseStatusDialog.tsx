...
export default function UpdateCaseStatusDialog({ caseId, status, isOpen, onClose, onSuccess }: Props) {
  ...
  async function handleSubmit() {
    ...
    setApiError(null);
    try {
      const data = {caseId: form.id, status: form.status};
      await apiPut(`${API.case}/status`, data);
      setForm(defaultForm);
